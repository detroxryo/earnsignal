...
<body>
  ...
  <main class="shell">
    ...
    <section class="controls" aria-label="Replay controls">
      ...
      <button class="primary" id="load">Load replay</button><button id="play">▶ Play</button><button id="speak">🔊 Read latest</button>
